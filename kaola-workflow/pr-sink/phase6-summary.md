...
`kaola-workflow/archive/pr-sink/`
...
| roadmap refresh | invoked | kaola-workflow/ROADMAP.md | Issue #7 row updated to closed |
| archive completed folder | complete | kaola-workflow/archive/pr-sink/ | |
