---
description: Claude Workflow Phase 1. Research/discovery only, with durable checkpoints and ECC exploration.
argument-hint: <task description, GitHub issue, or project name>
---

# Claude Workflow Phase 1 - Research / Discovery
...
```text
/claude-workflow-phase2 {project}
```
...
```text
claude-workflow/_phase1-pending/
claude-workflow/_phase1-pending/.cache/
claude-workflow/_phase1-pending/workflow-state.md
```

Move those captured files into `claude-workflow/{project-name}/` immediately
...
next_command: /claude-workflow-phase1 {task-or-project}
...
```text
claude-workflow/{project-or-_phase1-pending}/.cache/code-explorer.md
```
...
```text
claude-workflow/{project-or-_phase1-pending}/.cache/docs-lookup.md
```
...
existing `claude-workflow/{name}/`; if it exists, propose `{name}-2`.
...
phase: 1
step: complete
next_command: /claude-workflow-phase2 {project-name}
```
