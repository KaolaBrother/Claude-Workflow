---
description: Claude Workflow Phase 3. Build the executable implementation plan and task write sets.
argument-hint: <project name>
---

# Claude Workflow Phase 3 - Plan
...
claude-workflow/{project}/phase2-ideation.md
...
```text
/claude-workflow-phase4 {project}
```
...
```text
claude-workflow/{project}/.cache/architect.md
```
...
```text
claude-workflow/{project}/.cache/advisor-plan.md
```
...
```text
claude-workflow/{project}/.cache/architect-revision-{n}.md
```
...
Create `claude-workflow/{project}/phase3-plan.md`:
