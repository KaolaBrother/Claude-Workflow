...
function stateContent(routeResult) {
  ...
  return [
    ...
    routeResult.phase === 4 ? 'implementation_owner: current-codex-session' : 'implementation_owner: N/A',
    routeResult.phase >= 4 ? 'fix_owner: current-codex-session' : 'fix_owner: N/A',
    'subagents_authorized: explicit-user-request-only',
    '',
    '## Last Evidence',
